...
from ..security import (
    anonymize_student_data, secure_qr_data, contains_pii,
    validate_cors_origin, check_rate_limit, audit_log_hall_pass,
    generate_pseudonym, hash_sensitive_data, sanitize_input,
    get_security_headers, get_csp_header
)
...
class TestSecurityHardening(unittest.TestCase):
    ...
    def test_nested_data_anonymization(self):
        ...
        self.assertNotEqual(
            anonymized['student_info']['student_name'],
            'John Doe'
        )
        ...
        self.assertEqual(
            anonymized['student_info']['grade_level'],
            '5th'
        )
