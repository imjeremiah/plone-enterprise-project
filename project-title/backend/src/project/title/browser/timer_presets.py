...
class TimerPresetsView(BrowserView):
    ...
    DEFAULT_PRESETS = [
        {'name': 'Quick Activity', 'duration': 300, 'description': '5 minutes for warm-ups or quick tasks'},
        {'name': 'Group Work', 'duration': 600, 'description': '10 minutes for small group collaboration'},
        {'name': 'Individual Work', 'duration': 900, 'description': '15 minutes for independent practice'},
        {'name': 'Test/Quiz', 'duration': 1200, 'description': '20 minutes for assessments'},
        {'name': 'Presentation', 'duration': 1800, 'description': '30 minutes for student presentations'},
        {'name': 'Reading Time', 'duration': 2400, 'description': '40 minutes for sustained reading'},
    ]
        ...
        try:
            ...
            for preset in presets:
                if 'description' not in preset:
                    preset['description'] = f"{preset['duration'] // 60} minute activity"
