...
class RandomStudentPickerView(BrowserView):
    ...
    def pick_student(self):
        ...
        try:
            ...
            for student in students:
                ...
                if last_picked:
                    time_since_pick = (current_time - datetime.fromtimestamp(last_picked)).total_seconds()
            ...
            response_data = {
                ...
                'selection_weights': dict(zip(students, [round(w, 2) for w in weights]))
            }
    ...
    def update_pick_history(self, student_name):
        ...
        try:
            ...
            logger.info(f"Updated pick history for {student_name}: {history[student_name]['count']} times")
